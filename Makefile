...
./pars/env.c ./pars/expander.c ./pars/fill_node.c  ./pars/parser.c ./pars/parser_space_quotes.c ./pars/tokenizer.c ./pars/Wildcards.c ./pars/quotes.c  ./pars/checking.c ./pars/checking2.c
